...
func (cs *centralSystem) SignedUpdateFirmware(clientId string, callback func(confirmation *firmware.SignedUpdateFirmwareConfirmation, err error), requestId int, location, signature, signingCertificate string, retrieveDate *types.DateTime, props ...func(request *firmware.SignedUpdateFirmwareRequest)) error {
